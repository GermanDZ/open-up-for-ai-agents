---
title: Developer
source_url: process.openup.base/capabilitypatterns/developer_5015BA3A.html
type: RoleDescriptor
uma_name: developer
page_guid: _OADe0UVEEeK93ZZqiMLBsA
keywords:
- developer
- part
---
...
| **Responsible for:**
  * [Build](build-3.md)
  * [Design](design-10.md)
  * [Developer Test](developer-test-5.md)
  * [Implementation](implementation-7.md)
---|---
**Additionally Performs:**
  * [Deliver Release Communications](deliver-release-communications.md)
  * [Execute Backout Plan \(if necessary\)](execute-backout-plan-if-necessary.md)
  * [Execute Deployment Plan](execute-deployment-plan.md)
  * [Verify Successful Deployment](verify-successful-deployment.md)
...
See [Guideline: Staffing a Project](../../../practice-management/release_planning/guidances/guidelines/staffing-a-project.md) for more information about how several team members can fill this role.See [Guideline: Self-Organize Work Assignments](../../../practice-management/whole_team/guidances/guidelines/self-organize-work-assignments.md) for more information about how several team members can fill this role.

More Information

Guidelines|
  * [Self-Organize Work Assignments](../../../practice-management/whole_team/guidances/guidelines/self-organize-work-assignments.md)
