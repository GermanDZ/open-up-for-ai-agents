...
source_url: process.openup.base/capabilitypatterns/design_solution_7C602F6D.html
type: TaskDescriptor
uma_name: design_solution
page_guid: _frOcQNOKEdyqlogshP8l4g
keywords:
- design
- solution
related:
...
| Additional:
  ...
  * [Architect](architect-1.md)
  * [Stakeholder](stakeholder-1.md)
  * [Tester](tester-2.md)

| Assisting:
---|---|---|---
Inputs| Mandatory:
  * [\[Technical Architecture\]](./../../process.openup.base/capabilitypatterns/technical_architecture_slot_B93D7FFE.html)
...
Concepts|
  ...
  * [Requirements Realization](../../../practice-technical/evolutionary_design/guidances/concepts/requirements-realization.md)
---|---
Guidelines|
