---
title: Outline Deployment Plan
source_url: process.openup.base/capabilitypatterns/plan_deployment_C8487FE.html
type: TaskDescriptor
uma_name: plan_deployment
page_guid: _oaBE0JigEeGlkdGl1HQlDA
keywords:
- deployment
- outline
- plan
...
---|---|---|---
Outputs|
  * [Deployment Plan](deployment-plan-3.md)
