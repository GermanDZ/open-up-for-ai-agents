...
source_url: process.openup.base/capabilitypatterns/install_validate_infrastructure_5C9BCC48.html
type: TaskDescriptor
uma_name: install_validate_infrastructure
page_guid: _y7a0ApiLEeGOvpP1fVrVNA
keywords:
- infrastructure
- install
- validate
...
Outputs|
  * [Infrastructure](infrastructure-1.md)
