---
title: Analyst
source_url: process.openup.base/capabilitypatterns/analyst_6BC3A77A.html
type: RoleDescriptor
uma_name: analyst
page_guid: _N5e8wUVEEeK93ZZqiMLBsA
keywords:
- analyst
---
...
**Performs:**| **Responsible for:**
  * [Glossary](glossary-4.md)
  * [System-Wide Requirements](system-wide-requirements-4.md)
  * [Use Case](use-case-3.md)
  * [Use-Case Model](use-case-model-3.md)
  * [Vision](vision-8.md)
---|---
...
Assignment Approaches|  This role can be assigned in the following ways:
  ...
  * See [Guideline: Staffing a Project](../../../practice-management/release_planning/guidances/guidelines/staffing-a-project.md) to see how members of small agile teams can share in this role.
  * See [Guideline: Self-Organize Work Assignments](../../../practice-management/whole_team/guidances/guidelines/self-organize-work-assignments.md) to see how members of small agile teams can share in this role.
