...
source_url: process.openup.base/capabilitypatterns/envision_the_arch_A1FEF666.html
type: TaskDescriptor
uma_name: envision_the_arch
page_guid: _sjccUN_1EdyOsumnGvWsEg
keywords:
- architecture
- envision
related:
...
| Optional:
  * [Architecture Notebook](architecture-notebook.md)
...
Capture important decisions about the architecture in the [Architecture Notebook](../../../practice-technical/evolutionary_arch/workproducts/architecture-notebook-6.md) for future reference. Make sure that the team understands the architecture and can deliver it.
---
