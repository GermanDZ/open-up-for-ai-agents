---
title: Developer
source_url: process.openup.base/capabilitypatterns/developer_4B484B9F.html
type: RoleDescriptor
uma_name: developer
page_guid: _Nzu6EUVEEeK93ZZqiMLBsA
keywords:
- developer
- part
---
...
**Performs:**| **Responsible for:**
  * [Build](build-6.md)
  * [Design](design-4.md)
  * [Developer Test](developer-test-4.md)
  * [Implementation](implementation-5.md)
---|---
**Additionally Performs:**
  * [Assess Results](assess-results.md)
  * [Manage Iteration](manage-iteration.md)
  * [Outline Deployment Plan](outline-deployment-plan.md)
