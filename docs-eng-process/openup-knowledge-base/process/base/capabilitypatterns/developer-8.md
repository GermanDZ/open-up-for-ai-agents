---
title: Developer
source_url: process.openup.base/capabilitypatterns/developer_64FB0BCE.html
type: RoleDescriptor
uma_name: developer
page_guid: _N7P3UUVEEeK93ZZqiMLBsA
keywords:
- developer
- part
---
...
**Performs:**| **Responsible for:**
  * [Build](build-5.md)
  * [Design](design-6.md)
  * [Developer Test](developer-test-9.md)
  * [Implementation](implementation-9.md)
---|---
