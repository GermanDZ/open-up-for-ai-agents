---
title: Analyst
source_url: process.openup.base/capabilitypatterns/analyst_3A8CB05E.html
type: RoleDescriptor
uma_name: analyst
page_guid: _N8M5kUVEEeK93ZZqiMLBsA
keywords:
- analyst
---
...
**Performs:**| **Responsible for:**
  * [Glossary](glossary-5.md)
  * [System-Wide Requirements](system-wide-requirements-3.md)
  * [Use Case](use-case-4.md)
  * [Use-Case Model](use-case-model-8.md)
  * [Vision](vision-5.md)
---|---
