...
source_url: process.openup.base/capabilitypatterns/initiate_project_9D7C8344.html_wpbs.html
type: Activity
uma_name: initiate_project
page_guid: _nfpeAdOOEdyqlogshP8l4g
keywords:
- initiate
- plan
- project
...
---
Extends: [Initiate Project](initiate-project-7.md)
