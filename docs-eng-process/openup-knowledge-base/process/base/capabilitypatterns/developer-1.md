---
title: Developer
source_url: process.openup.base/capabilitypatterns/developer_34A6C6B6.html
type: RoleDescriptor
uma_name: developer
page_guid: _N90qMUVEEeK93ZZqiMLBsA
keywords:
- developer
- part
---
...
**Performs:**| **Responsible for:**
  * [Build](build-2.md)
  * [Design](design-11.md)
  * [Developer Test](developer-test-8.md)
  * [Implementation](implementation-4.md)
---|---
**Additionally Performs:**
  * [Develop Product Documentation](develop-product-documentation.md)
