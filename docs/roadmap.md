...
|---|---|---|---|---|
| [T-052](changes/T-052/plan.md) | Framework syncs must not leave uncommitted changes that trip on-stop (sync self-commits its CLI upgrades) | ready | medium | T-051 |
