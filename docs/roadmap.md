...
| ID | Title | Status | Priority | Depends on |
|---|---|---|---|---|
| T-104 | Engine-owned authoring ceremony (frontmatter stamping, config injection, ceremony-exclusion) + restore the pinned initial-roadmap contract (T-103 regression) | in-progress | high | — |
