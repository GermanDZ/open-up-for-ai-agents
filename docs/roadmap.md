...
|---|---|---|---|---|
| T-110 | Bootstrapped projects carry their own updater — ship `sync-from-framework.sh` via `process-manifest.txt` (+ atomic-rename install so a running sync can replace itself) | pending | high | — |
