...
| [T-114](changes/T-114/plan.md) | `/openup-init` template completeness — new `docs-eng-process/templates/project-status.md` + `roadmap.md`, and reference the existing `input-request.md` template for the stakeholder-brief step, instead of freehand heredoc authoring | ready | medium | — |
