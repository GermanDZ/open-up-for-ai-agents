...
source_url: core.mgmt.common.extend_supp/workproducts/work_items_list_39D03CC8.html
type: Artifact
uma_name: work_items_list
page_guid: _rGNWsCbSEdqh1LYUOGRh2A
keywords:
- item
- items
- list
...
---
Domains: [Project Management](../../cat/domains/project-management.md)
...
Fulfilled Slots|
  * [\[Project Status\]](./../../core.mgmt.slot.base/workproducts/project_status_slot_369775B5.html)
  * [\[Project Work\]](./../../core.mgmt.slot.base/workproducts/project_work_slot_F12BAC46.html)
---|---
Roles| Responsible:
  * [Project Manager](../../role/roles/project-manager-4.md)

| Modified By:
  * [Analyst](../../role/roles/analyst-6.md)
  * [Any Role](../../role/roles/any-role-1.md)
  * [Project Manager](../../role/roles/project-manager-4.md)
...
| Output From:
  ...
  * [Manage Iteration](../../../practice-management/iterative_dev/tasks/manage-iteration-1.md)
  * [Plan Iteration](../../../practice-management/iterative_dev/tasks/plan-iteration-1.md)
  * [Request Change](../../../practice-management/team_change_mgmt/tasks/request-change-1.md)
...
Templates|
  * [Work Items List](../guidances/templates/work-items-list-9.md)
---|---
Examples|
  * [Work Items List](../guidances/examples/work-items-list-8.md)
...
Checklists|
  * [Work Items List](../guidances/checklists/work-items-list-7.md)
---|---
Concepts|
...
Guidelines|
  * [Agile Estimation](../guidances/guidelines/agile-estimation.md)
