...
source_url: process.openup.base/capabilitypatterns/user_documentation_73287743.html
type: WorkProductDescriptor
uma_name: user_documentation
page_guid: _y7a0K5iLEeGOvpP1fVrVNA
keywords:
- documentation
- product
- system
...
The purpose of this work product is to ensure that end users of a particular application have enough information to use the product effectively.
---
...
| Optional:
  * [Develop Support Documentation](develop-support-documentation.md)
  * [Develop Training Materials](develop-training-materials.md)
...
Output From|
  * [Develop User Documentation](develop-user-documentation.md)
