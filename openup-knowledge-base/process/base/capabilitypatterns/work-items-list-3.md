...
source_url: process.openup.base/capabilitypatterns/work_items_list_A8A07014.html
type: WorkProductDescriptor
uma_name: work_items_list
page_guid: _HGqkMdnTEdyNj6EOmqy5Rg
keywords:
- item
- items
- list
...
Roles| Responsible: | Modified By:
  * [Any Role](any-role.md)
---|---|---
Output From|
  * [Request Change](request-change.md)
