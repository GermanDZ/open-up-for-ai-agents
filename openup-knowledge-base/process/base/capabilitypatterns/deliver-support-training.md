---
title: Deliver Support Training
source_url: process.openup.base/capabilitypatterns/deliver_support_training_222938DC.html
type: TaskDescriptor
uma_name: deliver_support_training
page_guid: _y7az7piLEeGOvpP1fVrVNA
keywords:
- deliver
- support
- training
...
---|---|---|---
Inputs| Mandatory:
  * [Support Documentation](support-documentation-1.md)
  * [Training Materials](training-materials-1.md)

| Optional:
  * [Product Documentation](product-documentation-1.md)
...
Validate support training logistics |  Before actually delivering the training to support personnel, ensure that you have all the necessary components of the training course, including:
  * Presentation slides
  * Handouts
  * Training aids
