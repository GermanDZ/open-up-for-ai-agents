...
source_url: process.openup.base/capabilitypatterns/support_documentation_C6712C82.html
type: WorkProductDescriptor
uma_name: support_documentation
page_guid: _y7az65iLEeGOvpP1fVrVNA
keywords:
- documentation
- support
related:
...
Input To| Mandatory:
  * [Deliver Support Training](deliver-support-training.md)
