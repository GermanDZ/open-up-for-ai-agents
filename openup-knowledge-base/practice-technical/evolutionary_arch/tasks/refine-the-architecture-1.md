...
source_url: practice.tech.evolutionary_arch.base/tasks/refine_the_arch_7723A69E.html
type: Task
uma_name: refine_the_arch
page_guid: _0gRJgMlgEdmt3adZL5Dmdw
keywords:
- architecture
- refine
related:
...
As you evolve the architecture, you may wish to evolve your architectural models. For more information, see [Guideline: Modeling the Architecture](../guidances/guidelines/modeling-the-architecture.md).
---
